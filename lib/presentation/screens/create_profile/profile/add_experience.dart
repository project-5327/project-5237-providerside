                            ...
                            children: [
                               Flexible(
                                child: CustomTextFormField(
                                  ...
                                  validator: (value) =>
                                      onboardingProvider.validateCompany(value ?? ''),
                                  controller: onboardingProvider.companyNameController,
                                ),
                              ),
                              SizedBox(
                                width: 5.w,
                               ...
                               Flexible(
                                child: CustomTextFormField(
                                  ...
                                  validator: (value) =>
                                      onboardingProvider.validateRole(value ?? ''),
                            ...
                            children: [
                               Flexible(
                                child: CustomTextFormField(
                                  ...
                                  controller: onboardingProvider.startDateController,
                                ),
                              ),
                              SizedBox(
                                width: 5.w,
                               ...
                               Flexible(
                                child: CustomTextFormField(
                                  ...
                                  validator: (value) =>
                                      onboardingProvider.validateDate(value ?? ''),
                                  controller: onboardingProvider.endDateController,
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                               Flexible(
                                child: CustomTextFormField(
                                  ...
                                  validator: (value) =>
                                      onboardingProvider.validateLocation(value ?? ''),
                                  controller: onboardingProvider.locationController,
                                ),
                              ),
                              SizedBox(
                                width: 5.w,
                               ...
                               Flexible(
                                child: CustomTextFormField(
                                  ...
                                  validator: (value) =>
                                      onboardingProvider.validateEmployementType(value ?? ''),
                                  controller: onboardingProvider.employementTypeController,
                                ),
                              ),
                            ],
                          ),
                          SizedBox(
                           ...
                           CustomTextFormField(
                            ...
                            title: AppStrings.description,
                             validator: (value) =>
                                 onboardingProvider.validateDescription(value ?? ''),
