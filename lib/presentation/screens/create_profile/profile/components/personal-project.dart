                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child:TextFormField(
                              maxLines: 4,
                              controller: onboardingProvider.projectDescriptionCOntroller,
                                  ...
                                  onTap: () {
                                   ...
                                   /* profileController.nextPage();
                                    ...
                                    onboardingProvider.addYourPersonalProject(
                                        ...
                                        onboardingProvider.projectDescriptionCOntroller.text,
                                        onboardingProvider.startDate2Controller.text,
                                        onboardingProvider.endDate2Controller.text,
                                        onboardingProvider.setTechnologies = _selectedSkills,
                                        isOngoing = true);
                                    Get.to(() => Profile8());
                                  }
                                //  },
    ...
    return Row(
      ...
      children: [
        GestureDetector(
          ...
          child: Row(
            children: [
              SvgPicture.asset(isselected == true
                  ? Assets.circle_dotIC
                  : Assets.circleIC),
              SizedBox(
                width: 2.w,
