    ...
    return Consumer<OnbaordingProvider>(builder: (context, onboardingProvider, child) {
        ...
        //   value = selectedCheckBoxValue;
              ...
              CustomizeButton(
                ...
                onTap: () {
                  // Capture the selected languages and proficiency
                  debugPrint("Selected languages: ${_selectedLanguages.length}");

                  // Set the selected languages in the provider
                  onboardingProvider.setLanguages = _selectedLanguages;

                  // Add languages to the provider (including optional proficiency)
